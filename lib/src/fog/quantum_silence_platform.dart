...
class QuantumSilencePlatform {
  static const MethodChannel _channel =
      MethodChannel('flutter_freedome/quantum_silence');
  static const EventChannel _stateChannel =
      EventChannel('flutter_freedome/quantum_silence/state');

  static final QuantumSilencePlatform _instance =
  ...
  Future<List<QuantumSilencePattern>> getSilencePatterns() async {
    try {
      ...
      return patternsJson
          .map((json) =>
              QuantumSilencePattern.fromJson(json as Map<String, dynamic>))
          .toList();
    } catch (e) {
  ...
  Future<void> setAbsorptionFrequency(double frequency) async {
    try {
      await _channel
          .invokeMethod('setAbsorptionFrequency', {'frequency': frequency});
    } catch (e) {
  ...
  Future<void> setAbsorptionAmplitude(double amplitude) async {
    try {
      await _channel
          .invokeMethod('setAbsorptionAmplitude', {'amplitude': amplitude});
    } catch (e) {
