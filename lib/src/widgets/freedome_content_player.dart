  ...
  Widget _buildStatusIcon(PlaybackStatus status) {
    switch (status) {
      case PlaybackStatus.playing:
        return Icon(Icons.play_circle_filled, color: Colors.green, size: 24);
      case PlaybackStatus.paused:
        return Icon(Icons.pause_circle_filled, color: Colors.orange, size: 24);
      case PlaybackStatus.stopped:
        return Icon(Icons.stop_circle, color: Colors.grey, size: 24);
