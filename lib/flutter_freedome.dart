...
/// - Гробовая тишина (95-99% поглощение звука)
/// - Генерация тумана для голографических проекций
/// - Полное отсутствие тумана (очистка купола)
/// - Полный режим купола (комбинированная настройка)
/// - Медитативная атмосфера (мягкая настройка)
///
/// ## Быстрый старт
///
/// ```dart
...
export 'src/widgets/quantum_silence_widget.dart';

// Экспорт квантовой системы тумана
export 'src/fog/quantum_fog_service.dart';
export 'src/fog/quantum_fog_models.dart';
export 'src/fog/quantum_fog_platform.dart';

// Экспорт квантовой системы поглощения звука
export 'src/fog/quantum_silence_service.dart';
export 'src/fog/quantum_silence_models.dart';
export 'src/fog/quantum_silence_platform.dart';
